...
var LogUI = function () {
	...
	var h = e(function (e) {
		var t = function (i) {
			...
			function s(e, t, n, r) {
				var a, i, s, c, o = t && t.prototype instanceof y ? t : y,
			...
			return ((c.prototype = S.constructor = u).constructor = c).displayName = a(u, r, "GeneratorFunction"), i.isGeneratorFunction = function (e) {
				...
				constructor: k,
				reset: function (e) {
					if (this.prev = 0, this.next = 0, this.sent = this._sent = f, this.done = !1, this.delegate = null, this.method = "next", this.arg = f, this.tryEntries.forEach(O), !e)
	...
	function _(e) {
		...
		for (n = r = h.length, r && h.push(x); n < p;) {
			for (o = g, v = 0; v < p; ++v) d <= (c = e[v]) && c < o && (o = c);
			for (o - d > k((g - t) / (u = n + 1)) && j("overflow"), t += (o - d) * u, d = o, v = 0; v < p; ++v)
				if ((c = e[v]) < d && ++t > g && j("overflow"), c == d) {
					for (a = t, i = y; !(a < (s = i <= m ? b : m + w <= i ? w : i - m)); i += y) f = a - s, l = y - s, h.push(L(C(s + f % l, 0))), a = k(f / l);
					h.push(L(C(a, 0))), m = function (e, t, n) {
						var r = 0;
						for (e = n ? k(e / S) : e >> 1, e += k(e / t); O * w >> 1 < e; r += y) e = k(e / O);
						return k(r + (O + 1) * e / (e + E))
					}(t, u, n == r), t = 0, ++n
				} ++t, ++d
		}
		return h.join("")
	...
	function $(e, t, n, r) {
		...
		for (var c, u, l = 0; l < s; ++l) {
			var f, h = e[l].replace(a, "%20"),
				p = h.indexOf(n),
				d = 0 <= p ? (f = h.substr(0, p), h.substr(p + 1)) : (f = h, ""),
	...
	function te(e, t, n, r) {
		...
		if (p && (u = (p = p[0]).toLowerCase(), e.protocol = u, s = s.substr(p.length)), (r || p || s.match(/^\/\/[^@\/]+@[^@\/]+/)) && (!(l = "//" === s.substr(0, 2)) || p && X[p] || (s = s.substr(2), e.slashes = !0)), !X[p] && (l || p && !Q[p])) {
			...
			for (-1 !== (m = -1 === v ? s.lastIndexOf("@") : s.lastIndexOf("@", v)) && (d = s.slice(0, m), s = s.slice(m + 1), e.auth = decodeURIComponent(d)), v = -1, b = 0; b < W.length; b++) - 1 !== (f = s.indexOf(W[b])) && (-1 === v || f < v) && (v = f); - 1 === v && (v = s.length), e.host = s.slice(0, v), s = s.slice(v), re(e), e.hostname = e.hostname || "";
			var g = "[" === e.hostname[0] && "]" === e.hostname[e.hostname.length - 1];
			if (!g)
				for (var y = e.hostname.split(/\./), b = 0, w = y.length; b < w; b++) {
					var E = y[b];
					if (E && !E.match(B)) {
						...
						if (!S.match(B)) {
							var x = y.slice(0, b),
								O = y.slice(b + 1),
								k = E.match(J);
							k && (x.push(k[1]), O.unshift(k[2])), O.length && (s = "/" + O.join(".") + s), e.hostname = x.join(".");
							break
						}
					}
				}
		...
		if (!Y[u])
			for (b = 0, w = G.length; b < w; b++) {
				var j, C = G[b]; - 1 !== s.indexOf(C) && ((j = encodeURIComponent(C)) === C && (j = escape(C)), s = s.split(C).join(j))
			}
		var U = s.indexOf("#"); - 1 !== U && (e.hash = s.substr(U), s = s.slice(0, U));
		var P, F = s.indexOf("?");
	...
	V.prototype.parse = function (e, t, n) {
		...
		if (e.protocol && e.protocol !== o.protocol) {
			...
			if (o.protocol = e.protocol, e.host || X[e.protocol]) o.pathname = e.pathname;
			else {
		...
		var d, m = o.pathname && "/" === o.pathname.charAt(0),
			v = e.host || e.pathname && "/" === e.pathname.charAt(0),
			g = v || m || o.host && e.pathname,
			y = g,
			b = o.pathname && o.pathname.split("/") || [],
			w = o.protocol && !Q[o.protocol],
			E = e.pathname && e.pathname.split("/") || [];
		if (w && (o.hostname = "", o.port = null, o.host && ("" === b[0] ? b[0] = o.host : b.unshift(o.host)), o.host = "", e.protocol && (e.hostname = null, e.port = null, e.host && ("" === E[0] ? E[0] = e.host : E.unshift(e.host)), e.host = null), g = g && ("" === E[0] || "" === b[0])), v) o.host = e.host || "" === e.host ? e.host : o.host, o.hostname = e.hostname || "" === e.hostname ? e.hostname : o.hostname, o.search = e.search, o.query = e.query, b = E;
		else if (E.length) (b = b || []).pop(), b = b.concat(E), o.search = e.search, o.query = e.query;
		else if (null != e.search) return w && (o.hostname = o.host = b.shift(), (d = !!(o.host && 0 < o.host.indexOf("@")) && o.host.split("@")) && (o.auth = d.shift(), o.host = o.hostname = d.shift())), o.search = e.search, o.query = e.query, U(o.pathname) && U(o.search) || (o.path = (o.pathname ? o.pathname : "") + (o.search ? o.search : "")), o.href = o.format(), o;
		if (!b.length) return o.pathname = null, o.search ? o.path = "/" + o.search : o.path = null, o.href = o.format(), o;
		for (var S = b.slice(-1)[0], A = (o.host || e.host || 1 < b.length) && ("." === S || ".." === S) || "" === S, I = 0, x = b.length; 0 <= x; x--) "." === (S = b[x]) ? b.splice(x, 1) : ".." === S ? (b.splice(x, 1), I++) : I && (b.splice(x, 1), I--);
		if (!g && !y)
			for (; I--;) b.unshift("..");
		!g || "" === b[0] || b[0] && "/" === b[0].charAt(0) || b.unshift(""), A && "/" !== b.join("/").substr(-1) && b.push("");
		var O = "" === b[0] || b[0] && "/" === b[0].charAt(0);
		return w && (o.hostname = o.host = !O && b.length ? b.shift() : "", (d = !!(o.host && 0 < o.host.indexOf("@")) && o.host.split("@")) && (o.auth = d.shift(), o.host = o.hostname = d.shift())), (g = g || o.host && b.length) && !O && b.unshift(""), b.length ? o.pathname = b.join("/") : (o.pathname = null, o.path = null), U(o.pathname) && U(o.search) || (o.path = (o.pathname ? o.pathname : "") + (o.search ? o.search : "")), o.auth = e.auth || o.auth, o.slashes = o.slashes || e.slashes, o.href = o.format(), o
	...
	var oe = e(function (e, t) {
		...
		r.prototype.addError = function (e) {
			var t;
			if ("string" == typeof e) t = new n(e, this.instance, this.schema, this.propertyPath);
			else {
	...
	ce.type = function (e, t, n, r) {
		...
		var o, a = new ae(e, t, n, r),
			i = Array.isArray(t.type) ? t.type : [t.type];
		...
		var o = new ae(e, t, n, r),
			a = new ae(e, t, n, r),
			i = t.oneOf.filter(ue.bind(this, e, n, r, function (e) {
				a.importErrors(e)
			})).length,
	...
	function fe(e, t, n, r, o, a) {
		if (this.types.number(e)) {
			...
			var s = new ae(e, t, n, r),
				c = oe.getDecimalPlaces(e),
				u = oe.getDecimalPlaces(i),
				l = Math.max(c, u),
				f = Math.pow(10, l);
	...
	function he(e, t, n) {
		for (var r = n.length, o = t + 1; o < r; o++)
			if (oe.deepCompareStrict(e, n[o])) return !1;
		return !0
	}
		...
		if (this.types.array(e)) {
			...
			return e.every(function (e, t, n) {
				for (var r = t + 1; r < n.length; r++)
					if (oe.deepCompareStrict(e, n[r])) return !1;
				return !0
			}) || o.addError({
				name: "uniqueItems",
	...
	var ve = {
		...
		scan: function (e, t) {
			...
			function a(e, t) {
				if (Array.isArray(t))
					for (var n = 0; n < t.length; n++) o(e + "/" + n, t[n])
			}
	...
	me.prototype.customFormats = {}, me.prototype.schemas = null, me.prototype.types = null, me.prototype.attributes = null, me.prototype.unresolvedRefs = null, me.prototype.addSchema = function (e, t) {
		...
		var o = (n = n || {}).propertyName || "instance",
			a = f.resolve(n.base || "/", t.id || "");
		if (!r) {
		...
		if (t.extends && (Array.isArray(t.extends) ? (o = {
			...
			var s = this.resolve(t, a, r),
				c = new we(s.subschema, n, r.propertyPath, s.switchSchema, r.schemas);
			return this.validateSchema(e, s.subschema, n, c)
		}
		var u, l, f = n && n.skipAttributes || [];
		for (u in t)
			if (!pe.ignoreProperties[u] && f.indexOf(u) < 0) {
				var h = null,
					p = this.attributes[u];
				if (p) h = p.call(this, e, t, n, r);
				else if (!1 === n.allowUnknownAttributes) throw new be("Unsupported attribute: " + u, t);
				h && i.importErrors(h)
	...
	var Ae = me,
		...
		xe = Ie.Validator,
		Oe = (Ie.ValidatorResult, Ie.ValidationError, Ie.SchemaError, Ie.SchemaScanResult, Ie.scan, Ie.validate, {
		...
		Ce = {
			addLogUIConfigProperty: function (e, t) {
				...
				ke.properties[e] = {
					type: t
				}, n && ke.required.push(e)
			},
			validateSuppliedConfigObject: function (e) {
				var t = new xe;
				return t.addSchema(ke, "/LogUI-logUIConfig"), t.addSchema(je, "/LogUI-trackingConfig"), t.addSchema(Le, "/LogUI-browserEvents"), t.validate(e, Oe)
			}
		};
	...
	var Fe = "logUI-sessionIDKey",
		Te = function (r) {
			...
			var f = function (e) {
				return d.extendObject(s, m.dispatcher), d.extendObject(s, e.logUIConfiguration), t = e.applicationSpecificData, i = e.trackingConfiguration, c = e.logUIConfiguration.browserEvents, !0
			};
			n.reset = function () {
	...
	// Cache changed from 10 to 1, Romy
	m.dispatcher = {
		endpoint: null,
				...
				onClose: function (e) {
					...
					switch (e.code) {
						...
						case 4002:
							...
							break;
						case 4003:
							t = "The LogUI server being connected to does not support version 0.5.3e of the client. LogUI is shutting down.";
							break;
						case 4004:
	...
	var Me, qe, ze, $e, Ve, Ne, Ze = function (e) {
		...
		He = qe = {
			...
			getValue: function (e, t) {
				if (t.hasOwnProperty("lookFor") && e[t.lookFor]) return e[t.lookFor]
			}
		},
		Ke = Object.freeze({
			__proto__: null,
	...
	for (ct in Je) ft["default" === ct ? "localStorage" : ct] = Je[ct];
	...
	var St, At, It = function () {
		...
		Ot = (St = {
			browserEvents: ["mouseenter", "mouseleave"],
			init: function () { },
			logUIEventCallback: function (e, t, n) {
				var r = At(n, t.type),
					o = {
	...
	var Lt, jt, Ct = {
		...
		Pt = (Lt = {
			...
			var e = new Date,
				t = Te.sessionData.getSessionStartTimestamp(),
				n = Te.sessionData.getLibraryStartTimestamp();
			return {
				eventType: null,
				eventDetails: {},
				...
				timestamps: {
					eventTimestamp: e,
					sinceSessionStartMillis: e - t,
					sinceLogUILoadMillis: e - n
				},
	...
	var Dt, _t, Rt, Mt, qt, zt = function () {
		...
		var h = function (e, t) {
			var n, r, o, a;
			l.has(e) && (r = (n = l.get(e)).handles.indexOf(t), n.handles.splice(r, 1), r = f.indexOf(t), f.splice(r, 1), 0 == n.handles.length && (l.delete(e), o = {
				type: "scrollEnd"
			}, (a = p(n.trackingConfig, "scrollEnd")) && (o.name = a), Pt.packageInteractionEvent(e, o, n.trackingConfig)))
		},
			p = function (e, t) {
				var n = e.properties;
				if (n && n.hasOwnProperty(t) && n[t].hasOwnProperty("name")) return n[t].name
	...
	for (Mt in xt) Vt["default" === Mt ? "mouseClick" : Mt] = xt[Mt];
	...
	function Nt(c) {
		...
		function t(e) {
			var t, n, r, o;
			if (e.test(u))
				for (n = 0, r = (t = u.match(e)).length; n < r; n += 1) o = t[n], u = u.replace(o, Array(o.length + 1).join("A"))
		}
		return e = function (e, t) {
			var n, r, o, a, i, s;
			if (e.test(u))
				for (r = 0, o = (n = u.match(e)).length; r < o; r += 1) l[t] += 1, a = n[r], i = u.indexOf(a), s = a.length, f.push({
					selector: c.substr(i, s),
					type: t,
					index: i,
					length: s
				}), u = u.replace(a, Array(s + 1).join(" "))
		}, t(/\\[0-9A-Fa-f]{6}\s?/g), t(/\\[0-9A-Fa-f]{1,5}\s/g), t(/\\./g),
			function () {
				var e, t, n, r, o = /{[^]*/gm;
				if (o.test(u))
					for (t = 0, n = (e = u.match(o)).length; t < n; t += 1) r = e[t], u = u.replace(r, Array(r.length + 1).join(" "))
	...
	var Jt, Yt, Xt, Qt = ((Jt = {}).generators = {
		...
		uniqueElements: h.mark(function e() {
			...
			return h.wrap(function (e) {
				for (; ;) switch (e.prev = e.next) {
					case 0:
						t = new Map, n = Kt(Jt.generators.trackingConfig()), e.prev = 2, n.s();
					case 4:
						if ((r = n.n()).done) {
							e.next = 28;
							break
	...
	}, Jt.processElement = function (e, t) {
		if (Te.DOMProperties.has(e)) {
			var n, r = Te.DOMProperties.get(e),
				o = Kt(t.eventsList);
			try {
				for (o.s(); !(n = o.n()).done;) {
					var a = n.value;
					if (r.hasEvent(a)) {
						var i = r.getEventGroupName(a),
							s = Te.elementTrackingConfig.getElementGroup(i).selector;
		...
		en = (Yt = {
			logUIEventCallback: function (e) {
				var t, n, r, o, a = Te.DOMProperties.get(e.target);
				2 == e.eventPhase && a && (t = a.getEventGroupName(e.type), n = Te.elementTrackingConfig.getElementGroup(t), o = !1, (o = (r = Ht.getEventHandler(n.event)) ? r.logUIEventCallback(this, e, n) : Xt(this, e, n)) && Pt.packageInteractionEvent(this, o, n))
			}
		}, Xt = function (e, t, n) {
			var r = {
				type: t.type
	...
	for (pn in xn) Cn["default" === pn ? "scroll" : pn] = xn[pn];
	...
	var Dn = function (e) {
		...
		var r = function (e) {
			...
			c = function (e) {
				var t, n = !1,
					r = Fn(Qt.generators.trackingConfig());
				try {
					for (r.s(); !(t = r.n()).done;) {
						var o = t.value;
		...
		Gn = (zn = window, $n = {
			...
			logUIStartedEvent: function () {
				var e = {
					...
					screenResolution: {
						width: zn.screen.width,
						height: zn.screen.height,
						depth: zn.screen.colorDepth
					},
					viewportResolution: {
						width: zn.innerWidth,
						height: zn.innerHeight
					}
				};
				Pt.packageStatusEvent(e)
			},
			logUIStoppedEvent: function () {
				Pt.packageStatusEvent({
					type: "stopped"
				})
			},
	...
	return Vn = window, (Nn = {
		...
		buildDate: "Wed May 05 2021 22:06:25 GMT+0100 (British Summer Time)"
...
let configurationObject = {
	...
	applicationSpecificData: {
		userName: user && user.name ? user.name : 'No User Found',
		userOrcID: user && user.orcid ? user.orcid : '',
		userID: user && user._id ? user._id : '',
		interface: 'UR_BASELINE'
	},
	trackingConfiguration: {
		// Signin
		'orcid-button-clicked': {
			selector: '#connect-orcid-button',
			event: 'mouseClick',
			properties: {
				primary: {
					name: 'clicked-on-orcid-button',
				},
			},
			metadata: [
				{
		...
		'search-query-issued': {
			selector: '#serp-query-form',
			event: 'formSubmission',
			name: 'search-query-issued',
			properties: {
				includeValues: [
					{
		...
		'serp-to-my-folder': {
			selector: '.serp-to-my-folder',
			event: 'mouseClick',
			properties: {
				primary: {
					name: 'serp-to-my-folder',
				}
			}
		},
		'my-folder-to-serp': {
			selector: '.my-folder-to-serp',
			event: 'mouseClick',
			properties: {
				primary: {
					name: 'my-folder-to-serp',
				}
			}
		},
		'saved-search-title-clicked': {
			selector: '.saved-search-query-log',
			event: 'mouseClick',
			properties: {
				primary: {
					name: 'saved-search-title-clicked',
				}
			},
			metadata: [
				{
					nameForLog: 'saved-search-query-title',
					sourcer: 'elementProperty',
					lookFor: 'textContent',
				}
			],
		},
		'search-history-title-clicked': {
			selector: '.search-history-query-log',
			event: 'mouseClick',
			properties: {
				primary: {
					name: 'search-history-title-clicked',
				}
			},
			metadata: [
				{
					nameForLog: 'search-history-query-title',
					sourcer: 'elementProperty',
					lookFor: 'textContent',
				}
			],
		...
		'load-more-saved-search-clicked': {
			selector: '.load-more-saved-search',
			event: 'mouseClick',
			properties: {
				primary: {
					name: 'load-more-saved-search-clicked'
				}
			}
		},

		'load-more-search-history-clicked': {
			selector: '.load-more-search-history',
			event: 'mouseClick',
			properties: {
				primary: {
					name: 'load-more-search-history-clicked'
				}
			}
		},

		'load-more-saved-records-clicked': {
			selector: '.load-more-saved-records',
			event: 'mouseClick',
			properties: {
				primary: {
					name: 'load-more-saved-records-clicked'
				}
			}
		},
		...
		// 			lookFor: 'data-task-name',
		// 		}
		// 	],
		// },
		// 'task-deleted': {
		// 	selector: '.task-card-delete',
		// 	event: 'mouseClick',
		// 	properties: {
		// 		primary: {
		// 			name: 'task-deleted',
		...
		// // Task Detail
		// 'task-detail-search': {
		// 	selector: '#task-detail-search-form',
		// 	event: 'formSubmission',
		// 	name: 'task-detail-query-issued',
		// 	properties: {
		// 		includeValues: [
		// 			{
		// 				nameForLog: 'taskDetailCompleteQuery',
		// 				sourcer: 'elementProperty',
		// 				selector: '#task-detail-search-form-query',
		// 				lookFor: 'value',
		// 			}
		// 		]
		// 	}
		// },
		// 'session-card-query-clicked': {
		// 	selector: '.session-card-query',
		// 	event: 'mouseClick',
		// 	properties: {
		// 		primary: {
		// 			name: 'session-card-query-clicked',
		// 		}
		// 	},
		// 	metadata: [
		// 		{
		// 			nameForLog: 'session-card-query-title',
		// 			sourcer: 'elementProperty',
		// 			lookFor: 'textContent',
		// 		}
		// 	],
		// },
		// 'task-detail-to-dashboard-button-clicked': {
		// 	selector: '.task-detail-to-dashboard-button',
		// 	event: 'mouseClick',
		// 	properties: {
		// 		primary: {
		// 			name: 'task-detail-to-dashboard-button-clicked',
		// 		}
		// 	}
		// },
		// 'task-detail-to-workspace-button-clicked': {
		// 	selector: '.task-detail-to-workspace-button',
		// 	event: 'mouseClick',
		// 	properties: {
		// 		primary: {
		// 			name: 'task-detail-to-workspace-button-clicked',
		// 		}
		// 	}
		// },
		// 'serp-form-search': {
		// 	selector: '#serp-form',
		// 	event: 'formSubmission',
		// 	name: 'serp-form-query-issued',
		// 	properties: {
		// 		includeValues: [
		// 			{
		// 				nameForLog: 'serpFormCompleteQuery',
		// 				sourcer: 'elementProperty',
		// 				selector: '#serp-form-input',
		// 				lookFor: 'value',
		// 			}
		// 		]
		// 	}
		// },
		// 'serp-to-task-detail-button-clicked': {
		// 	selector: '.serp-to-task-detail-button',
		// 	event: 'mouseClick',
		// 	properties: {
		// 		primary: {
		// 			name: 'serp-to-back-button-clicked',
		// 		}
		// 	}
		// },
		// 'doc-view-modal-close-clicked': {
		// 	selector: '.doc-view-modal-close',
		// 	event: 'mouseClick',
		// 	properties: {
		// 		primary: {
		// 			name: 'doc-view-modal-close-clicked',
		// 		}
		// 	}
		// },
		// 'doc-view-modal-close-top-clicked': {
		// 	selector: '.doc-view-modal-close-top',
		// 	event: 'mouseClick',
		// 	properties: {
		// 		primary: {
		// 			name: 'doc-view-modal-close-top-clicked',
		// 		}
		// 	}
		// },
		// 'workspace-to-task-detail-button-clicked': {
		// 	selector: '.workspace-to-task-detail-button',
		// 	event: 'mouseClick',
		// 	properties: {
		// 		primary: {
		// 			name: 'workspace-to-back-button-clicked',
		// 		}
		// 	}
		// },
	}
